<template>
  <div class="relative h-screen">
    ...
    <main class="main-page-height relative text-center">
      <label
      ...
      >
        ...
        <input
          @change="pdfHandler"
          class="mx-auto block w-5/6 text-sm text-slate-500 file:mr-4 file:rounded-lg file:border-0 file:bg-gradient-to-b file:from-green-600 file:to-green-900 file:py-2 file:px-4 file:text-sm file:font-semibold file:text-white"
          type="file"
